...
class mnist_fully_connected_IN2(nn.Module):
    def __init__(self, num_classes):
        super(mnist_fully_connected_IN2, self).__init__()
        self.hidden1 = 600
        self.hidden2 = 100
        self.fc1 = nn.Linear(28 * 28, self.hidden1, bias=False)
        self.fc2 = nn.Linear(self.hidden1, self.hidden2, bias=False)
...
class ResNet_IN2(nn.Module):
    def __init__(self, ResidualBlock, num_classes=10):
        super(ResNet_IN2, self).__init__()
...
def ResNet18_IN2():
    return ResNet_IN2(ResidualBlock)