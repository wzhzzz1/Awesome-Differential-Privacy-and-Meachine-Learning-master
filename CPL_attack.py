...
plt.clf()
#with open(f"./attack_image/attack_result_cifai10_lu.pkl", 'wb') as file:
#    pickle.dump(To_image(gt_data[0].cpu()), file)
net = LeNet().to(device)
...
for i in range(len(history)):
    with open(f"./attack_image/attack_result_eps8_cifar10_{i}.pkl", 'wb') as file:
